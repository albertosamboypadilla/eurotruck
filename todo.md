...
# Selección persistente por referencia, SKU o GTIN

- [x] Mantener como objetivo activo el código de referencia, SKU o GTIN introducido/escaneado.
- [x] Evitar que la selección de tarjetas sea necesaria para iniciar o continuar el conteo automático.
- [x] Sumar lecturas posteriores del mismo objetivo en la ubicación activa y permitir cambiarlo al introducir otro código.
- [x] Validar escaneo continuo, ubicación, alertas, 59 pruebas Vitest, TypeScript y build; publicar checkpoint.
