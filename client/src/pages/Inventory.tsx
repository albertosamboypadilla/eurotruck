  ...
  return <main className="inventory-page inventory-page--redesigned inventory-first-stage">
    ...
    <section className="inventory-workspace">
      <div className="inventory-scan-panel">
        ...
        {armedScanCode && selectedProduct && <div className="inventory-active-scan-target" role="status"><div><span className="orders-eyebrow">OBJETIVO DE ESCANEO</span><strong>{armedScanCode}</strong><small>{selectedProduct.name} · las próximas lecturas sumarán automáticamente en {tramo} / {gondola}</small></div><button type="button" className="inventory-active-scan-clear" onClick={() => { setArmedScanCode(""); setSelectedProduct(null); setScanCode(""); setLastScanAutoRecorded(false); setLastScanTotal(null); }}>Cambiar selección</button></div>}
