...
export default function Inventory() {
  ...
  const downloadLowStockExcel = () => {
    const rows = buildLowStockPurchaseRows(lowStockInventoryItems.map(item => ({ ...item, gtins: getGtinsForSku(item.sku, gtinMap) })), lowStockThreshold);
