...
export default function Orders() {
  ...
  const openQuote = (id: number, items: DraftLine[]) => {
    ...
    setDrafts(current => current[id] ? current : {
      ...current,
      [id]: items.map(item => {
        const inventoryPrice = availability.get(item.productId)?.salePrice;
