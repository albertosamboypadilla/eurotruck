  ...
  return (
    <div className="site-shell">
      <header className="site-header">
        ...
        <div className="portal-utility-bar"><div className="container-wide portal-utility-inner"><span><PackageCheck size={15} />50 000 artículos</span><span><ShoppingCart size={15} />Plataforma electrónica abierta las 24 horas</span><span><Truck size={15} />Entrega rápida</span><span><BadgeCheck size={15} />Servicio completo 360°</span><a href="mailto:eurotruckcxa@yahoo.com">HelpDesk</a></div></div>
      ...
      <main>
        ...
        <section className="catalog-section" id="catalogo">
          ...
          <div className="container-wide catalog-content">
            <div className="catalog-heading"><div><SectionLabel>PORTAL DE PIEZAS EUROTRUCK</SectionLabel><h2>Resultados de búsqueda<br /><span>Repuestos para tu flota</span></h2></div><p>La experiencia de consulta sigue la estructura del portal: busca por referencia o descripción, filtra por aplicación y abre cada ficha para ver la imagen y el enlace directo.</p></div>
            <div className="catalog-portal-search"><form className="catalog-search" onSubmit={submitCatalogSearch}><Search size={17} /><input value={catalogSearch} onChange={(event) => setCatalogSearch(event.target.value)} placeholder="N.º de referencia o descripción (DT, SA, OE, etc.)" /><button type="submit" aria-label="Buscar piezas"><Search size={16} /></button></form><button className="add-part-button" onClick={() => scrollToId("registro")}><Plus size={15} />Agregar Repuesto</button></div>
            ...
            <div className="catalog-meta"><span><PackageCheck size={14} />{catalogLoading ? "Cargando catálogo..." : `${formatCount(applicationResultCount)} resultados de la aplicación`}</span><span><span className="status-dot" />Miniaturas enlazadas a Diesel Technic</span></div>
