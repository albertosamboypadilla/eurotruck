    ...
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="catalog-section" id="catalogo">
          ...
          <div className="rino-catalog-figure" aria-hidden="true"><img src="/manus-storage/rino-assistant-3d_3bdd6acb.png" alt="" /><span>Rino Asistente</span></div>
